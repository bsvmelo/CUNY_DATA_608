...
mf.raw<-read.csv("https://media.githubusercontent.com/media/bsvmelo/Data608_Final_Project/master/MutualFunds.csv", sep = ",", header = TRUE, na.strings = c("N/A", ""))
...
mf.strat<-read.csv("https://raw.githubusercontent.com/bsvmelo/Data608_Final_Project/master/fund_strategy.csv",sep = ",", header = TRUE, na.strings = c("N/A", ""))
